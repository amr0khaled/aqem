...
import 'package:flutter_revision_1/core/utils/direction_utils.dart';
...
class _QiblaScreenState extends ConsumerState<QiblaScreen> {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              _angleCard(qiblah, deviceHeading),
  ...
  Widget _angleCard(double qiblaBearing, double deviceHeading) {
